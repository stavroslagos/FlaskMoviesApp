...
class Movie(db.Model):
    ...
    ## Integer, δήλωση πεδίου χρονιάς πρώτης προβολής της ταινίας με προεπιλεγμένη 
    # τιμή default=2000, υποχρεωτικό πεδίο
    release_year = db.Column(db.Integer, nullable=False, default=2000)
    ## δήλωση ημερομηνίας δημιουργίας ταινίας τύπου DateTime με προεπιλεγμένη 
    # τιμή: default=datetime.utcnow
